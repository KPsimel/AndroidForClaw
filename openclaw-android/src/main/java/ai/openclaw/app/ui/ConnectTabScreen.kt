...
fun ConnectTabScreen(viewModel: MainViewModel) {
  ...
  if (pendingTrust != null) {
    ...
    AlertDialog(
      ...
      title = { Text(stringResource(R.string.connect_trust_title), style = mobileHeadline, color = mobileText) },
      text = {
        Text(
          stringResource(R.string.connect_trust_text, prompt.fingerprintSha256),
          style = mobileCallout,
          color = mobileText,
        )
      },
      confirmButton = {
        TextButton(
          ...
          Text(stringResource(R.string.connect_trust_confirm))
        }
      },
      dismissButton = {
        TextButton(
  ...
  val notSetLabel = stringResource(R.string.connect_not_set)
  val activeEndpoint =
  ...
  Column(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
      ...
      Text(
        if (isConnected) stringResource(R.string.connect_active) else stringResource(R.string.connect_get_started),
        style = mobileCallout,
          ...
          if (config == null) {
            validationText =
              if (inputMode == ConnectInputMode.SetupCode) {
                context.getString(R.string.connect_validation_setup)
              } else {
                context.getString(R.string.connect_validation_manual)
              }
            return@Button
          }
    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text(stringResource(R.string.connect_last_error), style = mobileHeadline, color = mobileWarning)
    ...
    Surface(
      ...
      Row(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
          Text(stringResource(R.string.connect_advanced), style = mobileHeadline, color = mobileText)
          Text(stringResource(R.string.connect_advanced_desc), style = mobileCaption1, color = mobileTextSecondary)
        }
        Icon(
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          Text(stringResource(R.string.connect_method), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
          ...
          Text(stringResource(R.string.connect_run_on_host), style = mobileCallout, color = mobileTextSecondary)
          ...
          if (inputMode == ConnectInputMode.SetupCode) {
            ...
            OutlinedTextField(
              ...
              placeholder = { Text(stringResource(R.string.connect_paste_setup), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              minLines = 3,
              maxLines = 5,
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
              QuickFillChip(
                label = stringResource(R.string.connect_emulator),
                onClick = {
            ...
            Text(stringResource(R.string.connect_port), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
            ...
            Row(
              ...
              Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                ...
                Text(stringResource(R.string.connect_use_tls_desc), style = mobileCallout, color = mobileTextSecondary)
              }
              Switch(
            ...
            Text(stringResource(R.string.connect_password_optional), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
              value = passwordInput,
          ...
          TextButton(onClick = { viewModel.setOnboardingCompleted(false) }) {
            Text(stringResource(R.string.connect_run_onboarding), style = mobileCallout.copy(fontWeight = FontWeight.SemiBold), color = mobileAccent)
          }
        }
      }
    }
