...
fun VoiceTabScreen(viewModel: MainViewModel) {
  ...
  Column(
        ...
        item {
          Box(
            ...
            Column(
              ...
              Text(
                stringResource(R.string.voice_tap_mic),
                style = mobileHeadline,
                color = mobileTextSecondary,
              )
              Text(
                stringResource(R.string.voice_auto_send),
                style = mobileCallout,
    ...
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.spacedBy(4.dp)) {
          IconButton(
            ...
            Icon(
              ...
              contentDescription = if (speakerEnabled) stringResource(R.string.voice_mute_speaker) else stringResource(R.string.voice_unmute_speaker),
              modifier = Modifier.size(22.dp),
              tint = if (speakerEnabled) mobileTextSecondary else mobileDanger,
            )
          }
          Text(
            if (speakerEnabled) stringResource(R.string.voice_speaker) else stringResource(R.string.voice_muted),
        ...
        Box(
          ...
          Button(
            ...
            Icon(
              ...
              contentDescription = if (micEnabled) stringResource(R.string.voice_mic_off) else stringResource(R.string.voice_mic_on),
      ...
      val stateText =
        when {
          queueCount > 0 -> stringResource(R.string.voice_queued, queueCount)
          ...
          else -> stringResource(R.string.voice_mic_off_label)
        }
      val stateColor =
        when {
      ...
      if (!hasMicPermission) {
        ...
        Text(
          if (showRationale) {
            stringResource(R.string.voice_mic_permission_rationale)
          } else {
            stringResource(R.string.voice_mic_permission_blocked)
          },
        ...
        Button(
          ...
          Text(stringResource(R.string.voice_open_settings), style = mobileCallout.copy(fontWeight = FontWeight.SemiBold))
        }
      }
    }
  }
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) stringResource(R.string.sender_you) else stringResource(R.string.sender_ai),
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text(stringResource(R.string.chat_thinking_full), style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
